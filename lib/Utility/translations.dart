...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'help_message': 'This app helps visually impaired users with text recognition and object detection. Swipe or tap to navigate.',
          ...
          'scene_describer': 'Scene Describer',
        },
        'ur_PK': {
          // General
          ...
          'help_message': 'یہ ایپ بصری معذور صارفین کو متن کی شناخت اور اشیاء کی شناخت میں مدد کرتی ہے۔ نیویگیٹ کرنے کے لیے سوائپ یا ٹیپ کریں۔',
          
          // OCR screen
          'ocr_instructions': 'کیمرے کو متن کی طرف رکھیں اور تصویر لینے کے لیے ٹیپ کریں',
          ...
          // Bottomnav screen
          'currency_reader': 'روپیہ کا پھل',
          'color_identifier': 'رنگ کا پھل',
          'scene_describer': 'سینک کا پھل',
        },
      };
} 